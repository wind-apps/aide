...
import type { BaseSelection, CommandListenerPriority, GridSelection, LexicalNode, NodeSelection, RangeSelection } from 'lexical'
...
const lastSelection = ref<RangeSelection | NodeSelection | GridSelection | BaseSelection | null>(null)
